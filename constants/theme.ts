...
export const SIZES = {
  ...
  base: 8,
  font: 14,
  radius: Platform.OS === 'ios' ? 12 : 10,
  padding: Platform.OS === 'ios' ? 24 : 20,

  // font sizes
  largeTitle: 40,
  h1: Platform.OS === 'ios' ? 30 : 28, // Adjust for Android
  h2: Platform.OS === 'ios' ? 22 : 20, // Adjust for Android
  h3: Platform.OS === 'ios' ? 16 : 14, // Adjust for Android
  h4: Platform.OS === 'ios' ? 14 : 12, // Adjust for Android
  h5: Platform.OS === 'ios' ? 12 : 10, // Adjust for Android
  body1: Platform.OS === 'ios' ? 30 : 28, // Adjust for Android
  body2: Platform.OS === 'ios' ? 22 : 20, // Adjust for Android
  body3: Platform.OS === 'ios' ? 16 : 14, // Adjust for Android
  body4: Platform.OS === 'ios' ? 14 : 12, // Adjust for Android
  body5: Platform.OS === 'ios' ? 12 : 10, // Adjust for Android
