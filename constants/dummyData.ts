...
type lis1_type=categorie_type &{
    duration : string,
}
type list2_type= lis1_type &{
    instructor : string,
    ratings : number,
    price : number,
    is_favourite : boolean
}
type top_searches_type={
    id : number,
    label : string
}
type video_tpe={
...
type discussions_type={
    ...
    posted_on: string,
    comment: string,
    replies : replies_type[]
}
type course_details_type={
    id : number,
    title : string,
...
const categories : categorie_type[] = [
    {
        id: 0,
        title: "Mobile Design",
...
const courses_list_1 : lis1_type[] = [
    {
        id: 0,
...
const courses_list_2 : list2_type[] = [
    {
        id: 0,
...
const top_searches : top_searches_type[] = [
    {
        id: 0,
        label: "Sketch"
    },
...
const course_details : course_details_type = 
{
    id:0,
    title: "The Ultimate Ui/Ux Course Beginner to Advanced",
...
const notificationByDays : notificationByDays_type[] = [
    {
        title: "Today",
        data: [
            {
